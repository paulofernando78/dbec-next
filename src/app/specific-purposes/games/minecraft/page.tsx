    ...
    <>
      ...
      <div className="line-break">
        ...
        <div>
            ...
            <p>• Search for sheeps to collect (get) wool to make a bed. Beds are important to sleep through the night, because monsters come out, and it's dangerous.</p>
            <p>• If possible search for a village.</p>
            <p>• We can trade with villlagers many things, such as emerald, etc.</p>
            <p>• Things to do:</p>
