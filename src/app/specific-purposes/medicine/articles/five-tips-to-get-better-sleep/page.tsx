  ...
  return (
    <div>
      ...
      <div className="line-break">
        ...
        <div>
          <p>
            Some of the major causes are <b>stress</b>, <b>anxiety</b>, and a
            culture that experts say is about pro<mark>duc</mark>tivity, not
            rest.
          </p>
          <p className="portuguese">
        ...
        <div>
          <p>
            ...
            understand what your body needs and try your hardest to prioritize
        ...
        <div>
          <p>
            <b>1. Create a buffer zone</b>
          </p>
          <p className="portuguese">
            <b>Criar uma "zona de proteção"</b>
          </p>
        </div>
        <div>
          <p>
        ...
        <div>
          <p>
            ...
            center you and just helps you focus and release a lot of that
            tension from the day will then help promote sleep."
          </p>
          <p className="portuguese">
            A Dra. Annise Wilson, da Universidade Baylor, disse: "Qualquer coisa
            que ajude a centrar você e apenas ajude a focar e liberar muita da
            tensão do dia ajudará a promover o sono".
          </p>
        </div>
        <div>
          <p>
            <b>2. Watch what you eat</b>
          </p>
