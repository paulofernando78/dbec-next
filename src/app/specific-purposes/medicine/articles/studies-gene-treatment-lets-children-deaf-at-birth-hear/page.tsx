...
import { ArticleData, Articles } from "@/components/Articles/Articles";
...
const paragraphs: ArticleData[] = [
  ...
  },
  {
    firstEnParagraph:
      ...
      thirdEnParagraph: "to change a few of a patient's genes to cure a genetic disease.",
    ptParagraph:
      "A terapia genética é um tratamento médico que visa modificar alguns dos genes de um paciente para curar uma doença genética.",
  },
  {
    firstEnParagraph:
  ...
  },
  {
    ...
    ptParagraph:
      "Por volta do mesmo período, o Hospital Infantil da Filadélfia, no estado oriental da Pensilvânia, nos Estados Unidos, anunciou melhorias semelhantes em um menino de 11 anos lá tratado. E anteriormente, pesquisadores chineses publicaram um estudo mostrando melhorias semelhantes em outras duas crianças.",
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "Os métodos experimentais, ou terapias, visam apenas uma condição rara. Mas os cientistas afirmam que tratamentos semelhantes poderiam, um dia, ajudar muitas mais crianças com outros tipos de surdez causada por genes.",
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "Ao redor do mundo, 34 milhões de crianças têm surdez ou perda de audição. E informações dos Centros de Controle e Prevenção de Doenças dos Estados Unidos indicam que os genes são responsáveis por até 60 por cento dos casos.",
  },
  {
    firstEnParagraph:
    ...
    secondComponentProps: {
      audioSrc: "/s/sickle-.mp3",
      label: "sickle cell disease",
    },
    secondEnParagraph: " and severe hemophilia.",
  ...
  {
    firstEnParagraph: "<b>Treatment results</b>",
  ...
  },
  {
    ...
    ptParagraph:
      'A equipe gravou vídeos dos pacientes. Em um deles, um bebê, que anteriormente não conseguia ouvir nada, olha para trás em resposta às palavras de um médico seis semanas após o tratamento. Em outro vídeo, uma menininha, 13 semanas após o tratamento, repete "pai", "mãe", "avó", "irmã" e "eu te amo".',
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "Todas as crianças nos experimentos têm uma condição que se acredita causar de dois a oito por cento da surdez hereditária. É causada por mudanças em um gene responsável por uma proteína do ouvido interno chamada otoferlina, que ajuda as células ciliadas a enviar sinais sonoros para o cérebro.",
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "Os pesquisadores afirmam que a terapia única fornece uma cópia funcional desse gene para o ouvido interno durante uma operação médica. A maioria das crianças foi tratada em um ouvido, embora uma criança no estudo com duas pessoas tenha sido tratada em ambos os ouvidos.",
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "O estudo com seis crianças ocorreu na Universidade Fudan, em Xangai. O Dr. Yilai Shu ajudou a liderar o estudo e foi treinado no laboratório do Dr. Chen. Chen esteve envolvido na pesquisa. Organizações científicas chinesas e a empresa de biotecnologia Shanghai Refreshgene Therapeutics ajudaram a fornecer apoio financeiro.",
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "Os pesquisadores observaram as crianças por cerca de seis meses. Eles não sabem por que o tratamento não funcionou em uma delas. Mas os outros cinco, que eram completamente surdos, agora podem ouvir uma discussão normal, afirmaram os pesquisadores.",
  },
  {
    firstEnParagraph:
      "Chen estimated they now hear at a level 60 percent to 70 percent of normal. The therapy caused no major side effects.",
    ptParagraph:
      "Chen estimou que agora eles ouvem em um nível de 60 a 70 por cento do normal. A terapia não causou grandes efeitos colaterais graves.",
  },
  {
    firstEnParagraph:
      "Early results from other research have shown similar results.",
    ptParagraph:
      "Resultados iniciais de outras pesquisas têm mostrado resultados semelhantes.",
  },
  {
    firstEnParagraph:
  ...
  },
  {
    ...
    ptParagraph:
      'O Dr. Lawrence Lustig, da Universidade de Columbia, está envolvido no estudo da Regeneron. Ele disse que, embora as crianças nessas pesquisas não resultam com uma audição muito boa, "mesmo uma recuperação moderada da perda auditiva nessas crianças já é bastante impressionante".',
  },
  {
    firstEnParagraph:
    ...
    ptParagraph:
      "Ele acrescentou que muitas questões ainda permanecem (precisam ser discutidas). Elas incluem quanto tempo as terapias vão durar e se a audição continuará a melhorar nas crianças.",
  },
  {
    firstEnParagraph:
  ...
  },
  {
    ...
    ptParagraph:
      "Teresa Blankmeyer Burke é uma professora surda que lida com ética médica. Ela leciona na Universidade Gallaudet, uma universidade para pessoas surdas em Washington, D.C. Ela disse que não há consenso sobre a necessidade de terapia genética direcionada à surdez.",
  },
  {
    firstEnParagraph:
