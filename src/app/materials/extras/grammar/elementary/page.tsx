...
export default function ExtraGrammarElementary() {
  ...
  const extraGrammarElementaryContents = "/assets/data/materials/extra/grammar/elementary/contents.json";

  useEffect(() => {
    fetch(extraGrammarElementaryContents)
      .then((response) => {
