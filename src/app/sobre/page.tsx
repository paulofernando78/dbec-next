    ...
    <>
      <div className="line-break">
        ...
        <div className="line-break">
          ...
          <div>
            <p className="font-bold">
              • Intrax English Institute, San Diego – CA
            </p>
        ...
        <div className="line-break">
          <div>
            <p className="font-bold">• Seven Idiomas</p>
          ...
          <div>
            <p className="font-bold">• DAILY BASIS ENGLISH COURSE</p>
          ...
          <div>
            <p className="font-bold">• Osborn English School, São Paulo – SP</p>
          ...
          <div>
            <p className="font-bold">• House Teacher, Salvador – BA</p>
