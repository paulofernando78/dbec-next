...
const paragraphs: Paragraph[] = [
  {
    ...
    ptParagraph: "O governador da Flórida, Ron DeSantis, assinou uma lei na segunda-feira que proíbe crianças no estado com menos de 14 anos de terem uma conta em redes sociais.",
  },
  {
    paragraphNumber: "Paragraph 2",
    enParagraphs: [
      {
        enParagraph: "The measure requires parental permission before 14 and 15 year olds can sign up for personal social media accounts in Florida.",
      },
    ],
    ptParagraph: "A medida exige permissão dos pais para que jovens de 14 e 15 anos possam se inscrever em contas pessoais de redes sociais na Flórida.",
  },
  {
    ...
    ptParagraph: "Os defensores dizem que o projeto de lei protege as crianças de possíveis danos online, incluindo ameaças à saúde mental e à privacidade.",
  },
  {
  ...
  },
  {
    ...
    ptParagraph: "A legislatura da Flórida aprovou a lei no início deste mês. Esta foi a segunda versão da medida. A primeira versão, que foi aprovada pela legislatura da Flórida em fevereiro, teria proibido completamente crianças menores de 16 anos de usar redes sociais.",
  },
  {
  ...
  },
  {
    ...
    ptParagraph: "Em uma declaração, DeSantis disse que pesquisas mostraram repetidamente que os serviços de redes sociais podem prejudicar as crianças de várias maneiras importantes. A legislação, acrescentou, é projetada para dar aos pais \"uma maior capacidade de proteger seus filhos\".",
  },
  {
    ...
    ptParagraph: "A lei está prevista para entrar em vigor em 1º de janeiro de 2025. Mas especialistas dizem que a medida provavelmente enfrentará desafios legais nos tribunais.",
  },
  {
    ...
    ptParagraph: "DeSantis observou que outra lei que ele assinou há dois anos foi recentemente derrubada por um tribunal de apelações federal. Essa lei proibia os empregadores de exigirem sessões de treinamento que incluíssem discussões sobre raça, diversidade e outras questões. O tribunal de apelações decidiu que tais métodos de treinamento violavam os direitos constitucionais de liberdade de expressão dos empregadores.",
  },
  {
  ...
  },
  {
    ...
    ptParagraph: "O projeto de lei não menciona nenhum serviço de rede social específico, mas afirma que visa sites de redes sociais que usam ferramentas para manter os usuários online por longos períodos. A medida não abrange serviços que fornecem principalmente e-mail, mensagens ou serviços de texto.",
  },
  {
    ...
    ptParagraph: "A lei exige que as empresas de redes sociais removam permanentemente as informações pessoais coletadas de contas fechadas. Além disso, permite que os pais movam processos civis contra serviços que não cumprirem essa exigência.",
  },
  {
    ...
    ptParagraph: "Vários estados dos EUA têm considerado legislação semelhante. Em março de 2023, Utah se tornou o primeiro estado a promulgar leis que abrangem o uso de redes sociais por crianças. Medidas em Arkansas, Louisiana, Ohio e Texas logo seguiram. Vários outros estados também estão desenvolvendo novas regras nesse sentido.",
  },
  {
    ...
    ptParagraph: "A lei de Arkansas exigia o consentimento dos pais para menores criarem novas contas em redes sociais. Um juiz federal bloqueou a lei em agosto. O juiz decidiu que a legislação provavelmente era inconstitucional.",
  },
  {
