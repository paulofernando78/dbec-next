...
const descriptions = [
  {
    ...
    contents: [
      {
        checkboxLink:
          "/extras/listening/penguin-readers/beginner/a-new-zealand-adventure",
        checkboxLabelLink: "A New Zealand Adventure • 08:05",
      },
      {
        checkboxLink: "/extras/listening/penguin-readers/beginner/flying-home",
      ...
      {
        checkboxLink: "/extras/listening/penguin-readers/beginner/the-fireboy",
