...
import elementary from "./icon/elementary.png";
import preIntermediate from "./icon/pre-intermediate.png";
import intermediate from "./icon/intermediate.png";
import upperIntermediate from "./icon/upper-intermediate.png";
...
import foodDrinkIcon from "./icon/food-drink.png";
import dentistryIcon from "./icon/dentistry.png";
import gamesIcon from "./icon/games.png";
import geographyIcon from "./icon/geography.png";
import workoutIcon from "./icon/workout.png";
import hairdressingIcon from "./icon/hairdressing.png";
